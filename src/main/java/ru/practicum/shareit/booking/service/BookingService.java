...
public interface BookingService {
    ...
    List<BookingInfoDto> findAllBookingUser(long userId, String state, Pageable pageable);

    List<BookingInfoDto> findBookingAllItemsOwner(long userId, String state, Pageable pageable);
}
